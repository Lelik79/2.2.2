...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_open_notes) {
            ...
            Toast.makeText(MainActivity.this, "1.1.1 Открыть самую первую программу Hello World!", Toast.LENGTH_LONG).show();
            Intent intentNotes = new Intent(MainActivity.this, FirstActivity.class);
            startActivity(intentNotes);

        } else if (id == R.id.action_splash_screen) {

            Toast.makeText(MainActivity.this, "1.1.2. Открыть SplashScreenActivity!", Toast.LENGTH_LONG).show();
